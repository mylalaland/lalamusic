...
export default function DesktopPlayer() {
  ...
  const audioFormat = getFormatFromMime(track?.mimeType ?? undefined, (track?.name || track?.title) ?? undefined)
                  ...
                  {expandedView === 'lyrics' ? (
                    ...
                    <div className="space-y-1.5 max-w-3xl mx-auto">
                      ...
                      {playlist.map((t, i) => {
                        ...
                        const fmt = getFormatFromMime(t.mimeType ?? undefined, (t.name || t.title) ?? undefined)
                        return (
                          <div 
                            key={i}
