      ...
      <div className="px-8 pt-8 pb-4 relative z-10">
        ...
        <div className="flex items-center gap-4">
          <button 
             ...
             className="flex items-center gap-2 px-6 py-2.5 text-sm font-['Work_Sans'] font-bold tracking-wide text-[var(--on-primary)] transition-all hover:scale-105 active:scale-95 disabled:opacity-50 disabled:hover:scale-100"
             style={{ background: 'var(--primary)', boxShadow: 'var(--shadow-ambient)' }}
          >
      ...
      <div className="flex-1 overflow-y-auto px-6 pb-4 relative z-10" style={{ scrollbarWidth: 'thin', scrollbarColor: 'var(--bg-container-high) transparent' }}>
        {recentTracks.length === 0 ? (
           <div className="flex flex-col items-center justify-center py-32 gap-3 opacity-50">
             ...
             <p className="text-sm font-['Work_Sans'] text-[var(--text-muted)] tracking-[0.2em] uppercase">최근 재생한 곡이 없습니다.</p>
           </div>
        ) : (
              ...
              return (
                ...
                >
                  <div className="flex items-center gap-4 flex-1 min-w-0">
                    <div className="w-8 text-center text-[10px] font-['Work_Sans'] font-bold text-[var(--text-muted)] group-hover:text-[var(--tertiary)] transition-colors relative">
                      {active ? (
                        <div className="w-full flex justify-center">
                          <div className="w-2.5 h-2.5 bg-[var(--primary)] rounded-full animate-pulse shadow-[var(--shadow-ambient)]" />
                        </div>
                      ) : (
                    ...
                    <div className="w-10 h-10 relative bg-[var(--bg-container)] flex-shrink-0 border border-white/5 overflow-hidden flex items-center justify-center">
